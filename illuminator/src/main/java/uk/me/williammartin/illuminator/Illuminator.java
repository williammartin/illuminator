...
public class Illuminator<T> {
	...
	/**
	 * This is a static utility method and the entry point for illuminating on classes
	 * 
	 * @param clazz The class to illuminate
	...
	/**
	 * The construct method corresponds loosely to a constructor.newInstance(), creating
	 * a new object of the class the Illuminator object is wrapping
	 * 
	 * Currently this cannot deal with primitive arguments
	 * 
	 * @param args The arguments to be passed to the class constructor
